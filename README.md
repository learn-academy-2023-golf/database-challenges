...
This repository holds the Database and Active Record pair programming challenges for Unit 5 at LEARN Academy.
...
- File name: `topic-name1-name2.sql` (ex. associations-austin-sarah.md)
